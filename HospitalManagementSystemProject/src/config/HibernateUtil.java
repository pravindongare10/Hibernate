	...
	public static SessionFactory getSessionFactory() {
		...
		try {
			if(sf==null) {
				...
				map.put(Environment.URL,"jdbc:mysql://localhost:3306/hospro");
				...
				mds.addAnnotatedClass(Addmin.class);
				mds.addAnnotatedClass(Doctor.class);
				mds.addAnnotatedClass(Nurce.class);
				mds.addAnnotatedClass(PatientCheckup.class);
				mds.addAnnotatedClass(ReceptionPatientDetail.class);
				mds.addAnnotatedClass(Addmit.class);
